...
function ItemListContainer(){
    return(
        ...
        <Titulo />
        <div className="cards">
        <ItemCard title="Begginer" price={'$'+parseInt('2500')} stockProduct={10} discount={'Discount ' + parseInt('5') + '%'} month="4"  />
        <ItemCard title="Intermediate" price={'$'+parseInt('2700')} stockProduct={12} discount={'Discount ' + parseInt('10') + '%'}  month="8"/>
        <ItemCard title="Advanzed" price={'$'+parseInt('3000')} stockProduct={15} discount={'Discount ' + parseInt('15') + "%"}  month="12"/>
        </div>
        </div>
